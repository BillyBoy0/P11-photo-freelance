...
<div id="lightbox">
    ...
    <button id="next-button" class="lightbox-next" >Suivant &rarr;</button>
    <button id="prev-button" class="lightbox-prev" >&larr; Précédent</button>
    ...
    <div id="lightbox-images" style="display: none;">
        ...
        <div class="lightbox-item">
            <img src="<?php echo $thumbnail_url; ?>" reference="<?php echo get_field('reference'); ?>" data-category="<?php echo esc_attr($categories[0]->name); ?>" post-link="<?php echo esc_attr($post_url); ?>">
        </div>
        <?php endwhile; ?>
